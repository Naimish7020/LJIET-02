...
public class MergeTwosortedlinklist {
    ...
    public static LinkedListNode<Integer> MergeTwoSortedLinkedList(LinkedListNode<Integer> head1,
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < rounds; i++) {
            ...
            LinkedListNode<Integer> head = MergeTwoSortedLinkedList(head1, head2);
            print(head);
        }
    }
}
